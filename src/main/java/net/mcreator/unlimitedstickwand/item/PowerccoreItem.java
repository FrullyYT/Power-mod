...
public class PowerccoreItem extends UnlimitedStickWandModElements.ModElement {
	@ObjectHolder("unlimited_stick_wand:powerccore")
	public static final Item block = null;
	public PowerccoreItem(UnlimitedStickWandModElements instance) {
		super(instance, 10);
	}
