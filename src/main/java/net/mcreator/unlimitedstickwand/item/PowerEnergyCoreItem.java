...
public class PowerEnergyCoreItem extends UnlimitedStickWandModElements.ModElement {
	@ObjectHolder("unlimited_stick_wand:power_energy_core")
	public static final Item block = null;
	public PowerEnergyCoreItem(UnlimitedStickWandModElements instance) {
		super(instance, 17);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("power_energy_core");
		}
