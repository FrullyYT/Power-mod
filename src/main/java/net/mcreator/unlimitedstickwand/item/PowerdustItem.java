...
public class PowerdustItem extends UnlimitedStickWandModElements.ModElement {
	@ObjectHolder("unlimited_stick_wand:powerdust")
	public static final Item block = null;
	public PowerdustItem(UnlimitedStickWandModElements instance) {
		super(instance, 5);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("The power but broken down"));
		}
	}
}
