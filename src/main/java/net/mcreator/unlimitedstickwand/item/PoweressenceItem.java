...
public class PoweressenceItem extends UnlimitedStickWandModElements.ModElement {
	@ObjectHolder("unlimited_stick_wand:poweressence")
	public static final Item block = null;
	public PoweressenceItem(UnlimitedStickWandModElements instance) {
		super(instance, 12);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Power essence"));
		}
	}
}
