...
public class BasicpowercoreItem extends UnlimitedStickWandModElements.ModElement {
	@ObjectHolder("unlimited_stick_wand:basicpowercore")
	public static final Item block = null;
	public BasicpowercoreItem(UnlimitedStickWandModElements instance) {
		super(instance, 9);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("basicpowercore");
		}
