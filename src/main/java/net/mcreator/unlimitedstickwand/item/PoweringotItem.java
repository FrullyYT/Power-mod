...
public class PoweringotItem extends UnlimitedStickWandModElements.ModElement {
	@ObjectHolder("unlimited_stick_wand:poweringot")
	public static final Item block = null;
	public PoweringotItem(UnlimitedStickWandModElements instance) {
		super(instance, 6);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Power but ingot"));
		}
	}
}
